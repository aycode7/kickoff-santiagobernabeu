  ...
  return (
    <div>
        ...
        <div data-aos="fade-right" className="text">
            ...
            <p>Real Madrid absence from the 2024 Ballon d Or ceremony was quite the buzzworthy topic. The team decided to to boycott
                the event after learning that neither Vinicius Junior nor Dani Carvajal would take home the prestigious award.
            </p>

            <p>Apparently, Vinicius Jr was considered the top contender, but Manchester Citys Rodri ultimately won the award. Real 
                Madrid felt disrespected by this decision, releasing a statement saying that if the criteria did not favor Vinicius 
                as the winner, then it should have pointed to Carvajal.
            </p>

            <p>The teams dissatisfaction was evident, with no representatives attending the ceremony in Paris. This meant that Carlo
                Ancelotti who won the Mens Coach of the Year Trophy, was not present to accept his award.
            </p>

            <h1>Real Madrids Nominees Who Did Not Attend</h1>

            <p>● Vinicius Junior (nominated for Ballon d Or)</p>
            <p>● Jude Bellingham (nominated for Ballon d Or)</p>
            <p>● Dani Carvajal (nominated for Ballon d Or)</p>
            <p>● Kylian Mbappe (nominated for Ballon d Or)</p>
            <p>● Antonio Rüdiger (nominated for Ballon d Or)</p>
            <p>● Federico Valverde (nominated for Ballon d Or)</p>
            <p>● Andriy Lunin (nominated for Best GoalKeeper)</p>
            <p>● Arder Güler (nominated for the Kopa Trophy)</p>
            <p>● Carlo Ancelotti (nominated for Best Coach Of The Year)</p>
