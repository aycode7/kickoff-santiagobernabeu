  ...
  return (
    <div>
        ...
        <div data-aos="fade-right" className="text">
            <h1>Official Announcement From Real Madrid</h1>

            <p>27/10/2024</p>

            <p>Real Madrid strongly condemns any kind of behaviour involving racism, xenophobia or violence in football and sport, and
                deeply regrets the insults that a few fans uttered last night in one of the corners of the stadium.
            </p>

            <p>Real Madrid has opened an investigation in order to locate and identify the prepetrators of the deplorable and despicable 
                insults so that the appropriate disciplinary and judicial measures can be taken.
            </p>
