  ...
  return (
    <div>
        ...
        <div data-aos="fade-right" className="text">
            <h1>El Classico: Real Madrid vs Barcelona</h1>  

            <p>For all Barcelona fans the El Classico was a thriller, with Barcelona beating Real Madrid with a stunning 4 - 0 at the Santiago Bernabéu. Robert Lewandoski was unstoppable scoring 2 goals at the early stages of the second half, bringing his tally to 17 goals in 14 appearances this season.</p>  

            <p>The young sensation Lamine Yamal also made history becoming the youngest player to score in an El Classico at just 17 years and 106 days old, with Raphinha sealing the deal with a clever finish in the 84th minute.</p>
            
            <p>Despite the loss Real Madrid showed incredible determination and teamwork, Vinicius Junior was a constant threat and Kylian Mbappes disallowed goal was a masterpiece. The Frechmans skill and precision was undeniable, and he would surely bounce back from this setback.</p>

            <h1>Standout Performances</h1>
