        ...
        <div id='big' className='hidden md:hidden lg:hidden xl:block'>
            ...
            <div className='news'>
              ...
              <div data-aos="fade-right" className="text">
                <h1>Courtois medical report</h1>

                <p>MEDICAL REPORT 23/10/2024                             
                </p>

                <p>Following tests carried out on Real Madrid player Thibaut Courtois
              ...
              <div data-aos="fade-left" className="image">
                <Image className='img' src={courtois} alt='' priority />
              </div>
