...
import vini from './Image/mobile.jpg'
  ...
  return (
    <div>
        ...
        <div data-aos="fade-right" className="text">
            <h1>Vincuis Jr Star Play</h1>

            <p>Vinicuis Junior, the Brazilian superstar of Real Madrid, he has been unstoppable lately. His recent performance against Borussia Dortmund in the UEFA Champions League was truly breathtaking. He scored a sensational second-half hat-trick, one of those goals was scored single handedly with a solo run from Vini Jr, leading his team to a thrilling 5-2 comeback victory</p>

            <p>This win was especially impressive considering Dortmund had taken a 2-0 lead in the first-half of the game. However, Vinicuis incredible speed, skills, and determination turned the game around. His goals was testament to his exceptional finishing and decision-making abilities.</p>
        ...
        <div data-aos="fade-left" className="image">
            <Image className='img' src={vini} alt='' priority />
        </div>
